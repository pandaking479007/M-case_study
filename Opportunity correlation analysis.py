...
columns_to_exclude = ['OpportunityId', 'CreatedDate', 'DemoCreated','AcceptedDecisionDate','OwnerEmployeeId','OwnerEmployee','DateKey','Date','AcceptedDateKey','Accepted_date','Converted from chat']
...
plt.title('Opps Correlation Analysis', fontsize=20)
